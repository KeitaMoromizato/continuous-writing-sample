...
function getChangedText() {
  ...
  return new Promise(function (resolve, reject) {
    _this.githubAPI.pullRequests.getFiles(ghSetting, function (error, data) {
      ...
      _this.githubAPI.repos.getContent(extend({}, ghSetting, {
...
function postComment(text) {
  ...
  return new Promise(function (resolve, reject) {
    _this2.githubAPI.issues.createComment(extend({}, ghSetting, { body: text }), function (error, data) {
